...
make_svc_cert mission-service
make_svc_cert deployment-service
make_svc_cert dashboard-service
make_svc_cert alert-service
make_svc_cert traffic-management-service
make_svc_cert analytics-service
make_svc_cert ota-update-service
make_svc_cert device-core
make_svc_cert log-service
make_svc_cert db-manager
make_svc_cert manual-service
make_svc_cert ota-campaign-backend
